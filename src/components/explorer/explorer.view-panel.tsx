...
const LoadingState = () => (
  <div className="flex flex-col items-center justify-center p-8 text-center">
    <LucideLoader2 className="w-8 h-8 text-slate-400 animate-spin mb-4" />
...
const EmptyState = () => (
  <div className="flex flex-col items-center justify-center p-8 text-center">
    <div className="w-16 h-16 rounded-full bg-slate-700 flex items-center justify-center mb-4">
      <LucideFolder className="w-8 h-8 text-slate-400" />
    </div>
  ...
  <div className="sticky top-0 bg-slate-800 border-b border-slate-700 p-4 z-10">
    <div className="flex items-center gap-3">
      <div className="w-8 h-8 rounded-lg bg-sky-500/20 flex items-center justify-center">
        <LucideCloud className="w-4 h-4 text-sky-400" />
      </div>
      <div>
