...
import { Image, ImageGrid } from './images'
...
const ImageUploadPlaceholder = ({ onClick }: { onClick: () => void }) => (
  <div
    className={cn(
    ...
    <div className="overflow-y-auto overflow-x-hidden">
      <div id="main-image" className="mb-6 h-[350px]">
        {mainImage ? (
          ...
          <ImageUploadPlaceholder onClick={triggerFileInput} />
        )}
      </div>

      <ImageGrid items={restImages} handleRemoveImage={handleRemoveImage}>
